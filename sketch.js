...
function highlightBounce(str) {
  if (str == null) str = "";
  if (str != "") {
    push(); // really useful tool so that any style changes in this function don't affect the rest of the sketch, i.e. no side effects
    stroke(0, 0, 0);
    ...
    pop(); // restore previous style, used in conjunction with pushStyle()
  }
